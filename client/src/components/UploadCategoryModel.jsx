...
const UploadCategoryModel = ({close, fetchData}) => {
    ...
    const handleSubmit = async(e)=>{
        ...
        if(!data.name || !data.image){
            toast.error("Please enter category name and upload image")
            return
        }
        ...
        <div className='bg-white max-w-4xl w-full p-4 rounded'>
            ...
            <form className='my-3 grid gap-2' onSubmit={handleSubmit}>
                ...
                <button
                    ...
                    className={`
                    ${data.name && data.image && !loading ? "bg-primary-200 hover:bg-primary-100 cursor-pointer" : "bg-gray-300 cursor-not-allowed"}
                    py-2    
                    font-semibold
                    rounded
                    w-full
