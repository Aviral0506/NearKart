...
const Home = () => {
  ...
  console.log("Home - categoryData:", categoryData)
  console.log("Home - loadingCategory:", loadingCategory)
      ...
      <div className='container mx-auto px-4 my-2 grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8  gap-2'>
          {
            loadingCategory ? (
              ...
              <div className='col-span-full text-center py-10'>No categories available</div>
            )
          }
      </div>
