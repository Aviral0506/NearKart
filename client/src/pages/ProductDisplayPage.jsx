...
const ProductDisplayPage = () => {
  ...
  const fetchProductDetails = async()=>{
    try {
        ...
        if(responseData.success){
          console.log('Setting product data:', responseData.data)
  ...
  return (
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
        <div className=''>
            <div className='bg-white lg:min-h-[65vh] lg:max-h-[65vh] rounded min-h-56 max-h-56 h-full w-full flex items-center justify-center'>
        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
            ...
            <h2 className='text-lg font-semibold lg:text-3xl'>{data.name || 'Product'}</h2>  
            <p className=''>{data.unit || 'N/A'}</p> 
            <Divider/>
            <div>
              <p className=''>Price</p> 
              <div className='flex items-center gap-2 lg:gap-4'>
                <div className='border border-green-600 px-4 py-2 rounded bg-green-50 w-fit'>
                    <p className='font-semibold text-lg lg:text-xl'>
                      {data.price ? DisplayPriceInRupees(pricewithDiscount(data.price,data.discount)) : 'N/A'}
                    </p>
                </div>
                {
